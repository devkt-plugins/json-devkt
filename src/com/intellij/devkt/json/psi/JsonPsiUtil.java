...
import static com.intellij.devkt.json.JsonParserDefinition.JSON_COMMENTARIES;
...
public class JsonPsiUtil {
	 ...
	 * <p/>
	 * Ignore white spaces for any type of element except {@link com.intellij.devkt.json.JsonElementTypes#LINE_COMMENT}
	...
	/**
	 * @see #hasElementType(com.intellij.lang.ASTNode, org.jetbrains.kotlin.com.intellij.psi.tree.TokenSet)
	 */
	...
	/**
	 * @see #hasElementType(com.intellij.lang.ASTNode, org.jetbrains.kotlin.com.intellij.psi.tree.IElementType...)
	 */
	...
	public static PsiElement addProperty(@NotNull JsonObject object, @NotNull JsonProperty property, boolean first) {
		...
		if (!first) {
			final JsonProperty lastProperty = propertyList.get(propertyList.size() - 1);
